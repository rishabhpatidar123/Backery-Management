          ...
          <div className="lg:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
              ...
              <div className="flex items-center gap-4">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Elena" alt="Signature" className="w-12 h-12 rounded-full bg-white p-1 shadow-sm" />
                <div>
                  <p className="font-serif font-bold text-foreground">Elena Rossi</p>
